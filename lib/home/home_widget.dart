                ...
                child: Container(
                  ...
                  child: FutureBuilder<ApiCallResponse>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final columnUserDetailsResponse = snapshot.data!;
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                valueOrDefault<String>(
                                                  UserDetailsCall.username(
                                                    columnUserDetailsResponse
                                                        .jsonBody,
                                                  ),
                                                  'Your Username',
                                                ),
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return AlertDialog(
                                                                        title: Text(
                                                                            'Alert'),
                                                                        content:
                                                                            Text('Your Budget is not Enough'),
                                                                        actions: [
                                                                          TextButton(
                                                                            onPressed: () =>
                                                                      ...
                                                                      text:
                                                                        ...
                                                                        children: [
                                                                          TextSpan(
                                                                            text:
                                                                                valueOrDefault<String>(
                                                                              functions.calculationPersentage(
                                                                                  valueOrDefault<double>(
                                                                                    UserDetailsCall.totalBalance(
                                                                                      columnUserDetailsResponse.jsonBody,
                                                                                    )?.toDouble(),
                                                                                    0.00,
                                                                                  ),
                                                                                  valueOrDefault<double>(
                                                                                    UserDetailsCall.monthlySavingGoal(
                                                                                      columnUserDetailsResponse.jsonBody,
                                                                                    )?.toDouble(),
                                                                                    0.00,
                                                                                  )),
                                            ...
                                            child: Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      0.0, 10.0, 0.0, 0.0),
                                              child: Text(
                                                'A good score! You\'re a profitable person.',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .labelMedium
                                                        .override(
